...
IF (MPPDB_INITIALIZED) THEN
  !Check all IN arrays
  CALL MPPDB_CHECK(D,PZZ, "SHALLOW_MF beg:PZZ", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDZZ, "SHALLOW_MF beg:PDZZ", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRHODJ, "SHALLOW_MF beg:PRHODJ", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRHODREF, "SHALLOW_MF beg:PRHODREF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PPABSM, "SHALLOW_MF beg:PPABSM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PEXNM, "SHALLOW_MF beg:PEXNM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PSFTH, "SHALLOW_MF beg:PSFTH")
  CALL MPPDB_CHECK(D,PSFRV, "SHALLOW_MF beg:PSFRV")
  CALL MPPDB_CHECK(D,PTHM, "SHALLOW_MF beg:PTHM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRM, "SHALLOW_MF beg:PRM","VERTICAL")
  CALL MPPDB_CHECK(D,PUM, "SHALLOW_MF beg:PUM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PVM, "SHALLOW_MF beg:PVM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PTKEM, "SHALLOW_MF beg:PTKEM", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PSVM, "SHALLOW_MF beg:PSVM","VERTICAL")
  IF (PRESENT(PRSVS)) THEN
    IF (SIZE(PRSVS,1) > 0) THEN
      CALL MPPDB_CHECK(D,PRSVS, "SHALLOW_MF beg:PRSVS","VERTICAL")
    END IF
  END IF
  IF (PRESENT(PSVMIN)) THEN
    IF (SIZE(PSVMIN,1) > 0) THEN
      CALL MPPDB_CHECK(PSVMIN, "SHALLOW_MF beg:PSVMIN")
    END IF
  END IF
  !Check all INOUT arrays
  CALL MPPDB_CHECK(D,PTHL_UP, "SHALLOW_MF beg:PTHL_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRT_UP, "SHALLOW_MF beg:PRT_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRV_UP, "SHALLOW_MF beg:PRV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PU_UP, "SHALLOW_MF beg:PU_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PV_UP, "SHALLOW_MF beg:PV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRC_UP, "SHALLOW_MF beg:PRC_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRI_UP, "SHALLOW_MF beg:PRI_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PTHV_UP, "SHALLOW_MF beg:PTHV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PW_UP, "SHALLOW_MF beg:PW_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFRAC_UP, "SHALLOW_MF beg:PFRAC_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PEMF, "SHALLOW_MF beg:PEMF", D%NKT,"VERTICAL")
END IF
...
IF (MPPDB_INITIALIZED) THEN
  !Check all INOUT arrays
  CALL MPPDB_CHECK(D,PTHL_UP, "SHALLOW_MF end:PTHL_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRT_UP, "SHALLOW_MF end:PRT_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRV_UP, "SHALLOW_MF end:PRV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PU_UP, "SHALLOW_MF end:PU_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PV_UP, "SHALLOW_MF end:PV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRC_UP, "SHALLOW_MF end:PRC_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRI_UP, "SHALLOW_MF end:PRI_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PTHV_UP, "SHALLOW_MF end:PTHV_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PW_UP, "SHALLOW_MF end:PW_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFRAC_UP, "SHALLOW_MF end:PFRAC_UP", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PEMF, "SHALLOW_MF end:PEMF", D%NKT,"VERTICAL")
  !Check all OUT arrays
  CALL MPPDB_CHECK(D,PDUDT_MF, "SHALLOW_MF end:PDUDT_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDVDT_MF, "SHALLOW_MF end:PDVDT_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDTHLDT_MF, "SHALLOW_MF end:PDTHLDT_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDRTDT_MF, "SHALLOW_MF end:PDRTDT_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDSVDT_MF, "SHALLOW_MF end:PDSVDT_MF","VERTICAL")
  CALL MPPDB_CHECK(D,PSIGMF, "SHALLOW_MF end:PSIGMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRC_MF, "SHALLOW_MF end:PRC_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PRI_MF, "SHALLOW_MF end:PRI_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PCF_MF, "SHALLOW_MF end:PCF_MF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFLXZTHVMF, "SHALLOW_MF end:PFLXZTHVMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFLXZTHMF, "SHALLOW_MF end:PFLXZTHMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFLXZRMF, "SHALLOW_MF end:PFLXZRMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFLXZUMF, "SHALLOW_MF end:PFLXZUMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PFLXZVMF, "SHALLOW_MF end:PFLXZVMF", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PDETR, "SHALLOW_MF end:PDETR", D%NKT,"VERTICAL")
  CALL MPPDB_CHECK(D,PENTR, "SHALLOW_MF end:PENTR", D%NKT,"VERTICAL")
END IF
CONTAINS
