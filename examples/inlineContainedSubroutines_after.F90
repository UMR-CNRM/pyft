...
!
!Computation of an approximate state thanks to PRL and PRI guess
ZBUF(IIJB_2:IIJE_2, IEXN_2)=(ZPRES_F(IIJB_2:IIJE_2, JK+IKL)/CST%XP00) ** CST%RDSCPD

DO JIJ_2=IIJB_2,IIJE_2
  ZBUF(JIJ_2, I99PP_2)=0.99*ZPRES_F(JIJ_2, JK+IKL)
  ZRVMIX(JIJ_2)=PRT_UP(JIJ_2, JK)-ZRCMIX(JIJ_2)-ZRIMIX(JIJ_2)
  ZBUF(JIJ_2, ICPH_2)=CST%XCPD+ CST%XCPV * ZRVMIX(JIJ_2)+ CST%XCL * ZRCMIX(JIJ_2) + CST%XCI * ZRIMIX(JIJ_2) + ZBUF(JIJ_2, ICPH2_2)
  ZVAR2_2=ZBUF(JIJ_2, ICPH_2)*ZBUF(JIJ_2, IEXN_2)
  ZDELT_2=(PTHL_UP(JIJ_2, JK)*ZBUF(JIJ_2, IEXN_2))-CST%XTT
  ZBUF(JIJ_2, ILVOCPEXN_2) = (CST%XLVTT + (CST%XCPV-CST%XCL) * ZDELT_2) /ZVAR2_2
  ZBUF(JIJ_2, ILSOCPEXN_2) = (CST%XLSTT + (CST%XCPV-CST%XCI) * ZDELT_2) /ZVAR2_2 
  ZTHMIX(JIJ_2)=PTHL_UP(JIJ_2, JK)+ZBUF(JIJ_2, ILVOCPEXN_2)*ZRCMIX(JIJ_2)+ZBUF(JIJ_2, ILSOCPEXN_2)*ZRIMIX(JIJ_2)
  ZBUF(JIJ_2, I1PRT_2)=1+PRT_UP(JIJ_2, JK)
ENDDO
!
!
!       2 Iteration
...
DO II_2=1,JITER_2
  ...
  DO JIJ_2=IIJB_2, IIJE_2
    IF(ZRCMIX(JIJ_2)+ZRIMIX(JIJ_2) > 1.E-20) THEN
      ZFRAC_ICE(JIJ_2) = ZRIMIX(JIJ_2) / (ZRCMIX(JIJ_2)+ZRIMIX(JIJ_2))
    ENDIF
  ENDDO
  DO JIJ_2=IIJB_2, IIJE_2
  !$acc Meso-NH-champignon
...
!Computation of Rvsat and dRsat/dT
  ...
  DO JIJ_2=IIJB_2, IIJE_2
    ...
    ZRSATW_ED(JIJ_2) = CST%XRD/CST%XRV*ZBUF(JIJ_2, IFOESW_2)/ZPRES_F(JIJ_2, JK+IKL) / (1.+(CST%XRD/CST%XRV-1.)*ZBUF(JIJ_2, IFOESW_2)/ZPRES_F(JIJ_2, JK+IKL))
    ZRSATI_ED(JIJ_2) = CST%XRD/CST%XRV*ZBUF(JIJ_2, IFOESI_2)/ZPRES_F(JIJ_2, JK+IKL) / (1.+(CST%XRD/CST%XRV-1.)*ZBUF(JIJ_2, IFOESI_2)/ZPRES_F(JIJ_2, JK+IKL))
    ZTPOW2_2=ZBUF(JIJ_2, IT_2)**2
    ZBUF(JIJ_2, IDRSATODTW_2) = ZRSATW_ED(JIJ_2) / (1.+(CST%XRD/CST%XRV-1.)*ZBUF(JIJ_2, IFOESW_2)/ZPRES_F(JIJ_2, JK+IKL) ) &
                     * (CST%XBETAW/ZTPOW2_2 - CST%XGAMW/ZBUF(JIJ_2, IT_2))*ZBUF(JIJ_2, I1PRT_2)
    ZBUF(JIJ_2, IDRSATODTI_2) = ZRSATI_ED(JIJ_2) / (1.+(CST%XRD/CST%XRV-1.)*ZBUF(JIJ_2, IFOESI_2)/ZPRES_F(JIJ_2, JK+IKL) ) &
                     * (CST%XBETAI/ZTPOW2_2 - CST%XGAMI/ZBUF(JIJ_2, IT_2))*ZBUF(JIJ_2, I1PRT_2)
    !PRSATW(JIJ) =  QSAT(PBUF(JIJ, IT),PP(JIJ)) !qsatw
    !PRSATI(JIJ) = QSATI(PBUF(JIJ, IT),PP(JIJ)) !qsati
    !PBUF(JIJ, IDRSATODTW) =  DQSAT(PBUF(JIJ, IT),PP(JIJ),PRSATW(JIJ))*PBUF(JIJ, I1PRT)
    !PBUF(JIJ, IDRSATODTI) = DQSATI(PBUF(JIJ, IT),PP(JIJ),PRSATI(JIJ))*PBUF(JIJ, I1PRT)
    ...
    ZBUF(JIJ_2, IRLTEMP_2)=MIN(MAX(-ZRCMIX(JIJ_2)-ZRIMIX(JIJ_2), ZBUF(JIJ_2, IRLTEMP_2)),ZRVMIX(JIJ_2))
    ZRVMIX(JIJ_2)=ZRVMIX(JIJ_2)-ZBUF(JIJ_2, IRLTEMP_2)
    ZRCMIX(JIJ_2)=ZRCMIX(JIJ_2)+ZRIMIX(JIJ_2)+ZBUF(JIJ_2, IRLTEMP_2)
    ZRIMIX(JIJ_2)=ZFRAC_ICE(JIJ_2)     * (ZRCMIX(JIJ_2))
    ZRCMIX(JIJ_2)=(1-ZFRAC_ICE(JIJ_2)) * (PRT_UP(JIJ_2, JK) - ZRVMIX(JIJ_2))
    ...
    !Computation of L/Cph/EXN, then new PTH
    ZVAR2_2=ZBUF(JIJ_2, ICPH_2)*ZBUF(JIJ_2, IEXN_2)
    ZBUF(JIJ_2, ILVOCPEXN_2) = (CST%XLVTT + (CST%XCPV-CST%XCL) * (ZBUF(JIJ_2, IT_2)-CST%XTT)) /ZVAR2_2
    ZBUF(JIJ_2, ILSOCPEXN_2) = (CST%XLSTT + (CST%XCPV-CST%XCI) * (ZBUF(JIJ_2, IT_2)-CST%XTT)) /ZVAR2_2
    ZTHMIX(JIJ_2)=PTHL_UP(JIJ_2, JK)+ZBUF(JIJ_2, ILVOCPEXN_2)*ZRCMIX(JIJ_2)+ZBUF(JIJ_2, ILSOCPEXN_2)*ZRIMIX(JIJ_2)

    !Computation of estimated mixing ration at saturation
    !To compute the adjustement a first order development was used
    ZVAR1_2=ZTHMIX(JIJ_2)*ZBUF(JIJ_2, IEXN_2)-ZBUF(JIJ_2, IT_2)
    ZRSATW_ED(JIJ_2)=ZRSATW_ED(JIJ_2) + ZBUF(JIJ_2, IDRSATODTW_2)*ZVAR1_2
    ZRSATI_ED(JIJ_2)=ZRSATI_ED(JIJ_2) + ZBUF(JIJ_2, IDRSATODTI_2)*ZVAR1_2
  ENDDO
ENDDO
...
DO JIJ_2=IIJB_2,IIJE_2
  ...
  ZVAR2_3=ZBUF(JIJ_2, ICPH_2)*ZBUF(JIJ_2, IEXN_2)
  ZDELT_3=(ZMIXTHL(JIJ_2)*ZBUF(JIJ_2, IEXN_2))-CST%XTT
  ZBUF(JIJ_2, ILVOCPEXN_2) = (CST%XLVTT + (CST%XCPV-CST%XCL) * ZDELT_3) /ZVAR2_3
  ZBUF(JIJ_2, ILSOCPEXN_2) = (CST%XLSTT + (CST%XCPV-CST%XCI) * ZDELT_3) /ZVAR2_3 
...
!Computation of Rvsat and dRsat/dT
  ...
  DO JIJ_2=IIJB_2, IIJE_2
    ...
    !Computation of L/Cph/EXN, then new PTH
    ZVAR2_3=ZBUF(JIJ_2, ICPH_2)*ZBUF(JIJ_2, IEXN_2)
    ZBUF(JIJ_2, ILVOCPEXN_2) = (CST%XLVTT + (CST%XCPV-CST%XCL) * (ZBUF(JIJ_2, IT_2)-CST%XTT)) /ZVAR2_3
    ZBUF(JIJ_2, ILSOCPEXN_2) = (CST%XLSTT + (CST%XCPV-CST%XCI) * (ZBUF(JIJ_2, IT_2)-CST%XTT)) /ZVAR2_3
    ZTHMIX(JIJ_2)=ZMIXTHL(JIJ_2)+ZBUF(JIJ_2, ILVOCPEXN_2)*ZRC_MIX(JIJ_2, JK)+ZBUF(JIJ_2, ILSOCPEXN_2)*ZRI_MIX(JIJ_2, JK)

    !Computation of estimated mixing ration at saturation
    !To compute the adjustement a first order development was used
    ZVAR1_3=ZTHMIX(JIJ_2)*ZBUF(JIJ_2, IEXN_2)-ZBUF(JIJ_2, IT_2)
    ZRSATW_ED(JIJ_2)=ZRSATW_ED(JIJ_2) + ZBUF(JIJ_2, IDRSATODTW_2)*ZVAR1_3
    ZRSATI_ED(JIJ_2)=ZRSATI_ED(JIJ_2) + ZBUF(JIJ_2, IDRSATODTI_2)*ZVAR1_3
  ENDDO
ENDDO
